...
export default function QuoteTable({
    ...
    const handlePDFDownload = async (id, number) => {
        ...
        try {
            ...
            Swal.fire({
                ...
                icon: "success",
                title: "¡Exito!",
                text: "Se ha descargado la cotización",
            ...
            Swal.fire({
                ...
                icon: "error",
                title: "Error...",
                text: "No se ha podido descargar la cotización",
                showConfirmButton: false,
                timer: 1500
            });
    ...
    //Verifica si la cotización ya expiro
    const isItExpired = (date) => {
        var quoteExpirationDate = new Date(date);
        var currentDate = new Date();
        if (currentDate > quoteExpirationDate) {
            return true;
        }
        else {
            return false;
                    ...
                    <>
                        ...
                        <td className="actions">
                            ...
                            <Button
                                    ...
                                    variant="warning"
                                    onClick={() => onEdit(q)}
                                    disabled={isItExpired(q.quoteValidTil) == true || q.quoteStatus == "rejected" ? true : false}
                            >
                                Editar
                                </Button>
                                <Button
