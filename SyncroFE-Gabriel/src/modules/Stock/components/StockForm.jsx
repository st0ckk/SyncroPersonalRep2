    ...
    return (
        <form className="stock-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group full-width" style={{ marginTop: 4 }}>
                <strong style={{ fontSize: 14, color: "#1e293b" }}>Facturación electrónica</strong>
            </div>
            ...
            <div className="form-group full-width" style={{ position: "relative" }}>
                ...
                <input
                    ...
                    style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: "1px solid #e2e5ea", fontSize: 14, color: "#1e293b", background: "#ffffff" }}
                />
                <Button
                    type="button"
                    variant="primary"
